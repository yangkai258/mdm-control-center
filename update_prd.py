# -*- coding: utf-8 -*-
"""Update MULTI_TENANT_PRD.md - replace placeholder chapters 13-22 with full V2.0 content."""
...
管理表单字段的校验规则，支持正则表达式、函数和自定义错误消息。
...
| DELETE | `/api/v1/tenants/{tenant_id}/lowcode/tree/{model_code}/{id}` | 删除